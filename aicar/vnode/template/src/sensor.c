...
{
  static char lastA1=0, A1_count = 0;
...
void sensorPoll(void)
{
    ...
    static uint32_t lastCheckTm, lastUpdateTm;
    
    if (timeoutMs(lastCheckTm)){
        sensorCheck();
        lastCheckTm = millis()+100;
    }
